...
//    2) The ProfileExperience function returns a div containing a h3 tag with the company name and
// p tags containing the title and description pertaining to that experience.
